...
our $VERSION = '0.1';
my $dbh = database({ driver => 'mysql', database=>'fundraiser',host=>"mysql://$OPENSHIFT_MYSQL_DB_HOST",port=>$OPENSHIFT_MYSQL_DB_PORT,username=>'adminKcmiYjK',password=>'dP2tJsSDvSrz',connection_check_threshold=>10});
get '/' => sub {
    template 'index';
};
